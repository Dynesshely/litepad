...
const messages: Record<LocaleId, Record<string, string>> = {
  'zh-CN': {
    ...
    'cmd.nav.langMode': '切换代码语言…',
    'lang.current': '代码语言（着色）',
    'lang.auto': '自动检测',
    'lang.autoWith': '自动 · {lang}',
    'lang.plain': '纯文本',
    'lang.search': '搜索语言…',
    'lang.group.common': '常用',
    'lang.group.all': '全部',
    'lang.noMatch': '没有匹配的语言',
    'lang.note': '语言只影响语法着色，不会改动正文内容。',
    'lang.set': '已切换到 {lang}',
  ...
  'en-US': {
    ...
    'cmd.nav.langMode': 'Change language mode…',
    'lang.current': 'Code language (highlighting)',
    'lang.auto': 'Auto detect',
    'lang.autoWith': 'Auto · {lang}',
    'lang.plain': 'Plain text',
    'lang.search': 'Search languages…',
    'lang.group.common': 'Common',
    'lang.group.all': 'All',
    'lang.noMatch': 'No matching language',
    'lang.note': 'The language only affects syntax highlighting; the text is unchanged.',
    'lang.set': 'Switched to {lang}',
